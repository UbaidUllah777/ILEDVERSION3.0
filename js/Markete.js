...
// Medical
{
    ...
    marketeImagesForMarketePage:[
        {Image:'img/demos/iLEDv3/marketes/for index/Medical.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Medical.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Medical.jpg'},
    ]
...
// Automotive
{
    ...
    marketeImagesForMarketePage:[
        {Image:'img/demos/iLEDv3/marketes/for index/Automative.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Automative.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Automative.jpg'},
    ]
...
// Banking
{
    ...
    marketeImagesForMarketePage:[
        {Image:'img/demos/iLEDv3/marketes/for index/Banking.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Banking.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Banking.jpg'},
    ]
...
// Retail
{
    ...
    marketeImagesForMarketePage:[
        {Image:'img/demos/iLEDv3/marketes/for index/Retail.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Retail.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Retail.jpg'},
    ]
...
// Entertainment
{
    ...
    marketeImagesForMarketePage:[
        {Image:'img/demos/iLEDv3/marketes/for index/Entertainment.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Entertainment.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Entertainment.jpg'},
    ]
...
// Sports
{
    ...
    marketeImagesForMarketePage:[
        {Image:'img/demos/iLEDv3/marketes/for index/Sports.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Sports.jpg'},
        {Image:'img/demos/iLEDv3/marketes/for index/Sports.jpg'},
    ]
...
// Loading Markete Data In Mrkete Page: START

const ELaccordion100=document.getElementById("accordion100");
let accCount=1
for(const singleMarkete of ourMarkets){
    if(ELaccordion100){
        ELaccordion100.innerHTML+=`
        <div class="card card-default">
        <div class="card-header" id="collapse100Heading${accCount}">
          <h4 class="card-title m-0">
            <a class="accordion-toggle text-color-dark font-weight-bold collapsed" data-bs-toggle="collapse" data-bs-target="#collapse100${accCount}" aria-expanded="false" aria-controls="collapse100${accCount}">
              ${singleMarkete.marketeHeading}
            </a>
          </h4>
        </div>
        <div id="collapse100${accCount}" class="collapse" aria-labelledby="collapse1Heading${accCount}" data-bs-parent="#accordion100" style="">
          <div class="card-body">
            ...
            <div  id="marketeImages${accCount}" class="owl-carousel stage-margin stage-margin-sm nav-primary nav-svg-arrows-1 nav-dark custom-stage-outer-box-shadow" data-plugin-options="">
              ...
              <div class="col-lg-5 col-xl-6">
                <p class="">${singleMarkete.marketePara} </p>
        ...
        const ElmarketeImages=document.getElementById(`marketeImages${accCount}`);
...
// Loading Markete Data In Mrkete Page: END
